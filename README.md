...
4. Environment variable:
   - `VITE_API_URL=https://chill-zone-zombie-be.onrender.com`
...
6. After deploy, copy backend URL:
   - `https://chill-zone-zombie-be.onrender.com`
...
```bash
curl -s https://chill-zone-zombie-be.onrender.com/health

curl -s -X POST https://chill-zone-zombie-be.onrender.com/api/auth/login \
